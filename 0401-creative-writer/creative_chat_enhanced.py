...
app = Flask(__name__)
DB_FILE = "creative_system_pro_v6.db"
...
def send_daily_report():
    ...
    try:
        ...
        msg['From'] = email
        msg['To'] = email
        msg['Subject'] = f"📅 每日聊天记录 - {datetime.now().strftime('%Y年%m月%d日')}"
...
<body>
    ...
    <div class="main">
        <div class="header">
            ...
            <span class="header-title">✨ AI 创作系统 V6</span>
    ...
    <script>
        ...
        async function runSpider() {
            ...
            renderMessage('assistant', "⏳ 正在抓取最新情报并总结中...", null, null, new Date().toISOString());
...
def test_email():
    ...
    if success:
        ...
        return jsonify({"success": False, "error": "邮件发送失败，请检查配置"})
...
if __name__ == '__main__':
    print("🚀 AI 创作系统 V6 启动中...")
    print("📧 邮件通知服务已启动，每天8:00自动发送报告")
